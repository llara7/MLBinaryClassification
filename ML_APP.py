...
def main():
    ...
    def load_data():
        data = pd.read_csv("/Users/lauralara/PycharmProjects/MachineLearning/mushrooms.csv")
    ...
    st.sidebar.subheader("Pick a Classifier")
    ...
    if classifier == 'Support Vector Machine (SVM)':
        ...
        metrics = st.sidebar.multiselect("Pick one or more metrics to plot?",
